...
from .models import Equipment, Contact, GroupAccounting, UserAccounting, RentedEquipment, GroupComposition


@admin.register(Equipment)
class EquipmentAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'path', 'unique', 'number', 'price_per_day',
